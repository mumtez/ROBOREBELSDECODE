...
@Configurable
public class BaseFar15NonSpike {

  public static double INTAKE_TIMER = 300;
  ...
  PathChain shootPreLoad, preIntakeHP, intakeHP, shootHP, parkPath;

  public enum PathState {
    PRELOAD, CYCLE, STOP, PARK
  }
  ...
  public BaseFar15NonSpike(LinearOpMode opMode, Robot robot, double[] shootPos) {
    this.opMode = opMode;
